...
<div class="container d-flex align-items-center justify-content-center" style="margin-top:50px;">
    <div>
        <p style="font-size: 30px; color:white">OUR ORGANIZATIONAL HISTORY</p>
    </div>
</div>

<div class="container d-flex align-items-center justify-content-center" style="margin-top:50px;">
    <p style="text-align:center;font-size:1.2em; margin-left:50px;margin-right:50px">Contrary to popular belief, Lorem Ipsum is not simply random text.
